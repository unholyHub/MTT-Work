...
class gui {
    ...
    private function menu(){
        ...
        return (Session::logged_in()?'
            <ul>
              <li>
                <a href="./login.php?logout">'.locales::$text[menu_logout].'</a></li>':'<ul><li><a href="./login.php">'.locales::$text[menu_login].'</a></li>').'
              <li>  
              ...
              <li>
                ...
                '.(Session::access_is_allowed('has_payment_restrictions')?'
               <li>
                 <a href="./invoice_session.php">Invoice ('.(isset($_SESSION['invoice'])?count($_SESSION['invoice']['elements']):'0').')</a>
              </li>
           </ul>
            ':'</ul>').'
                <div style="float:right;margin-right:20px;">
            <a style="background:transparent; line-height:0;padding:0;margin:5px; float:left;" href="'.(strlen($qstr)>0?'?'.$qstr.'&':'?').'lang=bg"><img src="./images/bg.png" /></a>
            <a style="background:transparent; line-height:0;padding:0;margin:5px; float:left;" href="'.(strlen($qstr)>0?'?'.$qstr.'&':'?').'lang=en"><img src="./images/en.png" /></a>
                </div>';
    }
